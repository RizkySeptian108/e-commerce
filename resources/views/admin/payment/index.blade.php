                    ...
                    @foreach ($PaymentMethods as $PaymentMethod)
                        <tr>
                            ...
                            <td class="border border-slate-500 px-2 py-1 text-center">
                                <i class="fa-solid fa-pen-to-square mr-2 cursor-pointer text-yellow-500 dark:text-yellow-300" @click="update === {{ $PaymentMethod->id }} ? update = null : update = {{ $PaymentMethod->id }}"></i>
