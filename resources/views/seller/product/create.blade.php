    ...
    <div class="p-4 bg-white dark:bg-gray-500 rounded-md">
        <form action="{{ route('product.store') }}" method="post" class="md:w-1/2" enctype="multipart/form-data">
            ...
            <div class="mt-4">
                ...
                <textarea name="description" id="description" cols="30" rows="2" class="mt-1 block w-full border border-slate-300 dark:border-0 rounded-md dark:bg-gray-900 dark:text-slate-300" required>{{ old('description') }}</textarea>
